...
const pakistanProjects = [
  ...
  },
  {
    ...
    status: 'Current',
    location: 'Main Raiwind Road, Etihad Town, Lahore',
    totalArea: '10 storeys',
    description:
      'Premium vertical development on Main Raiwind Road — a 10-floor landmark blending prime commercial, corporate floors, and contemporary residences. Rooftop gardens, high-speed lifts, gated access, and smart building systems.',
    paymentPlan: 'Structured instalments — ask concierge for the live sheet.',
